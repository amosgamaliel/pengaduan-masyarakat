...
//                binding.tanggalPengaduan.text = niceDateStr
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tulisBalasButton.setOnClickListener {
            this.findNavController().navigate(DetailPengaduanFragmentDirections.actionDetailPengaduanFragmentToAjukanKeluhanActivity(viewModel.idPengaduan.value!!,viewModel.pengaduan.value!!.masyarakat_id))
        }
    }
